 ...
 * Plugin URI:        https://enteraddon.com/darklooks/
...
if (!defined('DARKLOOKS_VERSION')) {
    define('DARKLOOKS_VERSION', '1.0.7');
}
...
final class Darklooks
{
    ...
    public function client_insights()
    {
        ...
        $client = new Appsero\Client('688a08c5-9741-4d74-9256-4be4c528bbe1', 'DarkLooks &#8211; Dark Mode Switcher For WordPress', __FILE__);
